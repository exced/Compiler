...
if  (att_eval)      action_gen_96(x_2, x_5, x_9, x_10);
  ...
  private void regle95() throws Exception {
    ...
    //appel
if  (att_eval)      action_auto_inh_95(x_2, x_3, x_5);
    x_2.analyser() ;
    x_3.analyser(LEX_MCS.token_ident);
if  (att_eval)      action_decl_95(x_2, x_3, x_5);
    x_5.analyser() ;
if  (att_eval)      action_gen_95(x_2, x_3, x_5);
  }
private void action_auto_inh_95(S_TYPE_MCS x_2, T_MCS x_3, S_DECL_MCS x_5) throws Exception {
try {
// instructions
...
glob_96_infofonc.setAcces(this.att_hacces);
...
private void action_gen_95(S_TYPE_MCS x_2, T_MCS x_3, S_DECL_MCS x_5) throws Exception {
try {
// locales
INFOFONC loc_inf;
INFOVAR loc_iv;
...
private void action_decl_95(S_TYPE_MCS x_2, T_MCS x_3, S_DECL_MCS x_5) throws Exception {
try {
// instructions
