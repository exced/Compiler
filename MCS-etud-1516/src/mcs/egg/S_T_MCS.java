...
int [] sync= new int[0];
  ...
  private void regle53() throws Exception {
    ...
    //appel
if  (att_eval)      action_auto_inh_53(x_3, x_5);
if  (att_eval)      action_haddr_53(x_3, x_5);
    x_3.analyser() ;
if  (att_eval)      action_type_53(x_3, x_5);
    x_5.analyser() ;
if  (att_eval)      action_gen_53(x_3, x_5);
  }
private void action_auto_inh_53(S_F_MCS x_3, S_TX_MCS x_5) throws Exception {
try {
// instructions
...
private void action_haddr_53(S_F_MCS x_3, S_TX_MCS x_5) throws Exception {
try {
// instructions
...
private void action_type_53(S_F_MCS x_3, S_TX_MCS x_5) throws Exception {
try {
// instructions
...
private void action_gen_53(S_F_MCS x_3, S_TX_MCS x_5) throws Exception {
try {
// instructions
