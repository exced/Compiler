...
att_scanner._interrompre(IProblem.Semantic, att_scanner.getBeginLine(), IMCSMessages.id_typeError, MCSMessages.typeError,new Object[]{""+x_4.att_type.getNom(), ""+x_7.att_type.getNom()});
...
this.att_code_est_adresse=false;
this.att_sdep=0;
loc_i=this.att_machine.chercherClasse(x_5.att_sident);
if (loc_i==null){
att_scanner._interrompre(IProblem.Semantic, att_scanner.getBeginLine(), IMCSMessages.id_classe_not_found, MCSMessages.classe_not_found,new Object[]{""+x_5.att_sident, ""+this.att_machine.getClasses(), ""+this.att_machine.getNamespaces()});

}
else {
if (loc_i instanceof INFOCLASSE ){
loc_ic=((INFOCLASSE)loc_i);
loc_tdsContenu=loc_ic.getContenu();
loc_lch=loc_tdsContenu.toChamps();
loc_t=loc_ic.getType();
this.att_type=loc_t;
this.att_code_est_adresse=true;
