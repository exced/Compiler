...
if  (att_eval)      action_gen_71(x_2, x_4);
  ...
  private void regle63() throws Exception {
    ...
    //appel
if  (att_eval)      action_auto_inh_63(x_2, x_3);
    x_2.analyser() ;
    x_3.analyser() ;
if  (att_eval)      action_type_63(x_2, x_3);
if  (att_eval)      action_gen_63(x_2, x_3);
  }
...
if  (att_eval)      action_type_67();
  ...
  private void regle69() throws Exception {
    ...
    //appel
if  (att_eval)      action_auto_inh_69(x_3, x_5);
    x_2.analyser(LEX_MCS.token_paro);
    x_3.analyser() ;
    x_4.analyser(LEX_MCS.token_parf);
    x_5.analyser() ;
if  (att_eval)      action_type_69(x_3, x_5);
if  (att_eval)      action_gen_69(x_3, x_5);
  }
...
if  (att_eval)      action_auto_inh_68(x_3, x_6);
    ...
    x_3.analyser() ;
    x_4.analyser(LEX_MCS.token_parf);
if  (att_eval)      action_addr_68(x_3, x_6);
    x_6.analyser() ;
if  (att_eval)      action_type_68(x_3, x_6);
if  (att_eval)      action_gen_68(x_3, x_6);
  }
...
private void action_type_68(S_E_MCS x_3, S_FX_MCS x_6) throws Exception {
try {
// instructions
...
private void action_type_63(S_OPUN_MCS x_2, S_F_MCS x_3) throws Exception {
try {
// instructions
...
private void action_addr_68(S_E_MCS x_3, S_FX_MCS x_6) throws Exception {
try {
// instructions
x_6.att_ident="";
...
private void action_gen_63(S_OPUN_MCS x_2, S_F_MCS x_3) throws Exception {
try {
// instructions
this.att_code_est_adresse=false;
...
private void action_type_69(S_TYPE_MCS x_3, S_F_MCS x_5) throws Exception {
try {
// instructions
...
private void action_auto_inh_63(S_OPUN_MCS x_2, S_F_MCS x_3) throws Exception {
try {
// instructions
...
private void action_gen_68(S_E_MCS x_3, S_FX_MCS x_6) throws Exception {
try {
// instructions
...
private void action_auto_inh_68(S_E_MCS x_3, S_FX_MCS x_6) throws Exception {
try {
// instructions
x_3.att_machine=this.att_machine;
...
INFO loc_i2;
TDS loc_tdsParam;
boolean loc_estParam;
int loc_dep;
Register loc_LB;
// instructions
loc_tdsParam=this.att_tds.getParente();
loc_i2=loc_tdsParam.chercherLocalement(x_2.att_txt);
loc_estParam=!((loc_i2==null));
...
if (loc_estParam){
loc_dep=2-glob_71_iv.getDep();
}
else {
loc_dep=this.att_machine.getCurrentDep();
}
glob_71_code=this.att_machine.genReadMem(loc_dep-glob_71_iv.getTaille(), glob_71_iv.getTaille());
}
}
...
private void action_auto_inh_69(S_TYPE_MCS x_3, S_F_MCS x_5) throws Exception {
try {
// instructions
...
private void action_gen_69(S_TYPE_MCS x_3, S_F_MCS x_5) throws Exception {
try {
// instructions
