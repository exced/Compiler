...
if (loc_estParam){
loc_dep=2-glob_70_iv.getDep();
}
else {
loc_dep=this.att_machine.getCurrentDep();
}
glob_70_code=this.att_machine.genReadMem(loc_dep-glob_70_iv.getTaille(), glob_70_iv.getTaille());
}
}
...
x_4.att_tds=this.att_tds;
  ...
  public void analyser () throws Exception {
    ...
    switch ( scanner.fenetre[0].code ) {
      case LEX_MCS.token_entier : // 797
        regle59 () ;
      break ;
      case LEX_MCS.token_chaine : // 799
        regle60 () ;
      break ;
      case LEX_MCS.token_caractere : // 798
        regle61 () ;
      break ;
      case LEX_MCS.token_plus : // 789
        regle62 () ;
      break ;
      case LEX_MCS.token_moins : // 790
        regle62 () ;
      break ;
      case LEX_MCS.token_non : // 796
        regle62 () ;
      break ;
      case LEX_MCS.token_null : // 782
        regle66 () ;
      break ;
      case LEX_MCS.token_paro : // 749
        scanner.lit ( 2 ) ;
        switch ( scanner.fenetre[1].code ) {
          ...
          case LEX_MCS.token_paro : // 749
            regle67 () ;
          break ;
          case LEX_MCS.token_mult : // 792
            regle67 () ;
          break ;
          case LEX_MCS.token_ident : // 800
            regle67 () ;
          break ;
