...
int [] sync= new int[0];
  ...
  private void regle82() throws Exception {
    ...
    //appel
    x_2.analyser(LEX_MCS.token_bool);
if  (att_eval)      action_type_82();
  }
...
private void action_type_82() throws Exception {
try {
// instructions
this.att_type= new DTYPEImpl("bool", 1);
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MCS", "#type","STYPE -> bool #type ;"});
}
  }
