...
if  (att_eval)      action_gen_35(x_4);
  ...
  private void regle28() throws Exception {
    ...
    S_WHILE_MCS x_5 = new S_WHILE_MCS(scanner,att_eval) ;
    T_MCS x_6 = new T_MCS(scanner ) ;
    //appel
if  (att_eval)      action_auto_inh_28(x_4, x_5);
    x_2.analyser(LEX_MCS.token_do);
if  (att_eval)      action_hbloc_28(x_4, x_5);
    x_4.analyser() ;
    x_5.analyser() ;
    x_6.analyser(LEX_MCS.token_pv);
if  (att_eval)      action_gen_28(x_4, x_5);
  }
...
private void action_auto_inh_28(S_BLOC_MCS x_4, S_WHILE_MCS x_5) throws Exception {
try {
// instructions
...
x_5.att_tds=this.att_tds;
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MCS", "#auto_inh","INST -> do #hbloc BLOC WHILE pv #gen ;"});
}
  }
...
private void action_hbloc_28(S_BLOC_MCS x_4, S_WHILE_MCS x_5) throws Exception {
try {
// instructions
x_4.att_hbloc_est_fonction=false;
glob_28_etiquette="loop"+this.att_machine.getXEtiq();
x_5.att_ident=glob_28_etiquette;
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MCS", "#hbloc","INST -> do #hbloc BLOC WHILE pv #gen ;"});
}
  }
...
private void action_gen_28(S_BLOC_MCS x_4, S_WHILE_MCS x_5) throws Exception {
try {
// instructions
this.att_code=glob_28_etiquette+":\n"+x_4.att_code+x_5.att_code;
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MCS", "#gen","INST -> do #hbloc BLOC WHILE pv #gen ;"});
}
  }
...
x_5.att_identSuper=this.att_identSuper;
x_8.att_identSuper=this.att_identSuper;
