...
public class S_MODE_MCS {
LEX_MCS scanner;
  S_MODE_MCS() {
    }
  S_MODE_MCS(LEX_MCS scanner, boolean eval) {
...
private void action_mode_100() throws Exception {
try {
// instructions
this.att_mode="out";
...
this.att_mode="ref";
  ...
  public void analyser () throws Exception {
    ...
    switch ( scanner.fenetre[0].code ) {
      case LEX_MCS.token_ref : // 58317
        regle99 () ;
      break ;
      case LEX_MCS.token_out : // 58318
        regle100 () ;
      break ;
      default :
