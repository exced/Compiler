...
this.att_tds.inserer(x_3.att_txt, glob_85_ins);
}
...
x_4.att_tds_asm=this.att_tds;
  ...
  public void analyser () throws Exception {
    ...
    switch ( scanner.fenetre[0].code ) {
      case LEX_MCS.token_typedef : // 664
        regle3 () ;
      break ;
      ...
      case LEX_MCS.token_asm : // 660
        regle82 () ;
      break ;
      case LEX_MCS.token_namespace : // 667
        regle85 () ;
      break ;
      case LEX_MCS.token_using : // 668
        regle86 () ;
      break ;
      case LEX_MCS.token_public : // 670
        regle89 () ;
      break ;
      case LEX_MCS.token_private : // 671
        regle89 () ;
      break ;
      case LEX_MCS.token_class : // 669
        regle89 () ;
      break ;
      default :
